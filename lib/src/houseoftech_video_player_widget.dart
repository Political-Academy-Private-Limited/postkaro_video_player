...
///
/// Requires a [HouseOfTechController] to control playback.

class HouseOfTechVideoPlayer extends StatefulWidget {
  ...
  /// Creates a [HouseOfTechVideoPlayer].
  ///
...
class _HouseOfTechVideoPlayerState extends State<HouseOfTechVideoPlayer>
